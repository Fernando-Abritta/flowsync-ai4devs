...
_Motivo de la propuesta: el PRD solo dice que aparezcan solos los cambios hechos por **otras** personas. Sobre lo que uno mismo acaba de crear no dice nada, y sin escribirlo cabe una lectura en la que crear te obliga a ir a buscar el resultado, que es justo la fricción que el requisito de origen quita._
