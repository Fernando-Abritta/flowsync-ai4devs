...
> **Por qué importa más de lo que parece.** El PRD reconoce que el producto solo evita la colisión que lo motiva _si los títulos resultan reconocibles para un compañero_. Poder corregir un título es lo único que permite arreglar esa apuesta cuando sale mal.
...
_Motivo de la propuesta: ningún requisito dice si la edición se confirma o se guarda sola al escribir. Se propone que haya un punto explícito de guardado, porque con roles planos cualquiera edita tareas ajenas y un guardado automático convierte un clic accidental en un cambio para todo el equipo._
