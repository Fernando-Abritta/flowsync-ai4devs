...
> **Por qué esta historia sirve directamente a la promesa del producto.** La mitad del valor que el PRD promete es _elegir lo siguiente sabiendo qué está libre_. Sin poder coger una tarea, el equipo sabe quién está en qué pero no puede actuar en consecuencia.
...
_Motivo de la propuesta: el PRD garantiza que toda tarea nace con responsable, pero no dice si puede quedarse sin él después. Se propone que no: una lista que responde «quién está en qué» pierde sentido en cuanto admite filas sin nadie, y aparecería la papelera de tareas huérfanas que el producto no quiere._
