...
_Motivo de la propuesta: el requisito de origen habla de admitir «con holgura» una frase descriptiva y de avisar ante uno «desmedido», sin fijar dónde está la frontera, y el propio PRD lo señala como no verificable tal y como está escrito (PA-9). Este criterio fija solo la conducta observable, avisar en lugar de recortar. **El umbral sigue sin decidir y aquí no se inventa ninguno.**_
