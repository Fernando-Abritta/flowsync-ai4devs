...
_Motivo de la propuesta: el PRD lo excluye del alcance por decisión explícita, calificándolo de vigilancia, pero lo hace en la tabla de exclusiones y no como requisito. Sin un criterio negativo aquí, «responder quién está en qué» invita justo a construirlo._
