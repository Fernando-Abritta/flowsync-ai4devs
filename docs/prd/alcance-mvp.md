...
De ahí el principio de diseño que no se negocia: **la superficie donde elijo mi siguiente tarea y la superficie donde cambio el estado son la misma.** En el momento en que actualizar deje de ser algo que hago _para mí_ y pase a ser algo que hago _para que otros vean_, se convierte en reporte y el producto muere.
...
- **Lo comprobable aquí, y es un proxy:** abrir FlowSync y responder _quién está en qué y qué hay libre_ sin preguntar a nadie ni abrir otra cosa. Construir la vertical no equivale a validar la hipótesis.
